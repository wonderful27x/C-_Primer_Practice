//====================文本查询程序-查询部分=================
//为什么要学习文本查询程序？
//文本查询程序是C++_Primer经典用例，它的核心是教会我们如何使用标准库以及如何利用c++的继承体系以面向对象的程序设计思想来解决复杂问题，这也正是c++的精髓所在。
//该程序涵盖的知识点：


//文本查询程序简介：
//文本查询程序的目标是在给定的一篇文章中查询一个单词，并输出其在文章中出现的行号，并且程序支持~、&、|这样的复杂的复合查询，如~可以输出单词未出现的行号，&和|可以对两个对象的查询结果取交集和并集
//文本查询程序主要分为两大部分：
